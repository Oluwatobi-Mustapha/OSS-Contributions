...
4. [Patched a TOCTOU race condition in OTP verification to prevent token reuse under concurrent requests in `better-auth`](https://github.com/better-auth/better-auth/pull/8067)
